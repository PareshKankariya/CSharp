...
{    
    class MembershipFunctions
    {
        ...
        public void ArticlesAndVideos()
        {
            ...
            IWebElement nutritionTips = driver.FindElement(By.XPath(UIElements.FindUIElements.nutritionTips));
            IWebElement fitnessVideos = driver.FindElement(By.XPath(UIElements.FindUIElements.fitnessVideos));
            IWebElement dailyRecipes = driver.FindElement(By.XPath(UIElements.FindUIElements.dailyRecipes));
